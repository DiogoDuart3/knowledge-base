    ...
    <div class="container">
        <div class="row">
            ...
            <div class="input-group col-md-4 offset-md-4">
                <div class="row position-absolute mr-2" style="right: 0;">
