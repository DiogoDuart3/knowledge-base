                ...
                <div class="card col-12 p-0" mb-5>
                    ...
                    <div class="card-footer text-muted">
                        <div class="row">
                            ...
                            <span>
                                {{ count($post->comments) }} <i class="far fa-comments"></i>
                            </span>
                                <span class="mr-5 ml-5"></span>
                                <span>
                                    @if($post->confirmed_by_admin)
                            ...
                            <div class="col-sm">
                                <span class="float-right">{{ Carbon\Carbon::parse($post->created_at)->format('H:i | d-m-Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
