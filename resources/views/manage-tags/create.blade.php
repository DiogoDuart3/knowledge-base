...
@section('content')
    <div class="container">
        <h1 class="text-center mb-4">Create Tag</h1>
        ...
        {!! Form::model($tag, ['method'=>'POST', 'action'=>'TagController@store', 'class'=>'form-inline']) !!}
        <div class="form-group max-sm-5 mb-2 col-6">
            <label for="category-name" class="col-6">Tag name</label>
            <div class="col-sm-6">
