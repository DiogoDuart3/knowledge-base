        ...
        <div class="row mt-5 ml-1 mr-1">
            <div class="card col-12 p-0" mb-5>
                <div class="card-header">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="text-center">Parse error: syntax error, unexpected '  ' (T_STRING)</h2>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-sm">
                            ...
                            <span><strong>Username</strong></span></div>
            ...
            <div class="row mt-5 w-100">
                <div class="col-12">
                    <h2 class="text-center">Comentários <i class="far fa-comment-alt"></i></h2>
                    <hr class="w-75">
                </div>
            </div>
            <div class="row w-100">
